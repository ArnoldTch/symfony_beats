 ...
 */
final class Version20241215221944 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE composition DROP title, DROP file, DROP image');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE composition ADD title VARCHAR(255) NOT NULL, ADD file VARCHAR(255) NOT NULL, ADD image VARCHAR(255) NOT NULL');
    }
}
